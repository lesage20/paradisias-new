      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div>
          ...
          <input
            ...
            type="text"
            placeholder="Code, nom du coupon..."
      ...
      >
        ...
        <div class="p-6 border-b border-gray-200 bg-gradient-to-r from-purple-50 to-purple-100">
          <div class="flex items-center justify-between">
            ...
            <span :class="getCouponStatusClass(coupon)" class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium">
        ...
        <div class="p-6">
          ...
          <div class="flex items-center justify-between pt-4 border-t border-gray-200 mt-4">
            <div class="flex items-center space-x-2">
              ...
              <button @click="editCoupon(coupon)" class="p-2 rounded-lg text-blue-600 hover:text-blue-900 hover:bg-blue-50 transition-colors duration-200">
                <Edit class="w-4 h-4" />
              </button>
            </div>
            <button @click="deleteCoupon(coupon)" class="p-2 rounded-lg text-red-600 hover:text-red-900 hover:bg-red-50 transition-colors duration-200">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-2">
                Valeur de réduction *
                <span v-if="form.discount_type === 'percentage'" class="text-xs text-gray-500">(en %)</span>
            ...
            <div>
              ...
              <input
                ...
                min="0"
                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                placeholder="Montant minimum pour utiliser le coupon"
              />
            </div>
...
const maxDiscount = computed(() => {
  ...
  const percentageCoupons = coupons.value.filter(c => c.discount_type === 'percentage')
  if (percentageCoupons.length === 0) return 0
  return Math.max(...percentageCoupons.map(c => c.discount_value || 0))
})
...
const formatDiscount = (coupon) => {
  if (coupon.discount_type === 'percentage') {
    ...
    return `${new Intl.NumberFormat('fr-CI').format(coupon.discount_value)} FCFA`
  }
}
