    ...
    <div v-if="!isLoading" class="bg-white rounded-lg shadow-sm border border-gray-200">
      ...
      <div v-else class="p-6">
        <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
          <div v-for="room in occupiedRooms" :key="room.id"
            ...
            <div class="mt-4 flex space-x-2">
              <button @click="viewLocationDetails(room.currentLocation)"
              ...
              <button @click="extendStay(room.currentLocation)"
    ...
    <div v-if="!isLoading" class="bg-white rounded-lg shadow-sm border border-gray-200">
      ...
      <div v-else class="p-6">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
          <div v-for="room in freeRooms" :key="room.id"
...
const getCurrentLocationForRoom = (roomId) => {
  return locations.value.find(location => {
    ...
    console.log({ checkInField, checkOutField })
    if (!checkInField || !checkOutField) return false
    ...
    try {
      ...
      // const validStatus = ['pj', 'dj', 'dt', 'dp', 'ongoing'].includes(location.status) // Tous les statuts actifs
